...
export type BodyWithFormat = { format?: string };
...
export class SerDesSingleton<T> implements SerDes<T> {
  serializer: SerDes<T>;
...
export interface OpenApiValidatorOpts {
  ...
  serDes?: SerDes<any>[]; // serializer deserializer
  formats?: Format[];
  // removeAdditional is an AjvOption.  OpenApiValidatorOpts gets merged into ajvOpts: AjvOptions in framework/ajv.ts->createRequestAjv.  Putting it here is an easy way to expose this singular Ajv option.
